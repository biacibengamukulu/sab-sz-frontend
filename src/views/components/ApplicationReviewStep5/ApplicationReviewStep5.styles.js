...
export const StyledApplicationReviewstep5Container = styled.div.attrs({
  className: 'StyledApplicationReviewstep5Container',
})`
  && {
    ${tw`relative`}
  }
...
export const StyledFieldsIssuanceFeeContainer = styled.div.attrs({
  className: 'StyledFieldsIssuanceFeeContainer',
})`
  && {
    ${tw`relative grid`}
    margin-top: 40px;
...
`;
export const StyledIssuanceFeeActionsContainer = styled.div.attrs({
  className: 'StyledIssuanceFeeActionsContainer',
})`
  && {
...
`;
export const StyledIssuanceFeeProofOfPaymentContainer = styled.div.attrs({
  className: 'StyledIssuanceFeeProofOfPaymentContainer',
})`
  && {
    ${tw`relative flex`}
    height: 44px;
...
`;
export const StyledIssuanceFeeFieldReviewActions = styled.div.attrs({
  className: 'StyledIssuanceFeeFieldReviewActions',
})`
  && {
    ${tw`relative flex`}
    width: 100%;
