...
} from './ApplicationFormStep2.styles';
...
const ApplicationFormStep2 = () => {
  ...
  const { useApplicationFormStep2 } = useComponentHooks();
  ...
  const {
    ...
    defaultValues: {
      ...
      payerCellphone: '76543210',
      type_of_payment_second_step: 1,
      postal_residence_address: '',
      outlet_adress: '',
      reference: '',
      payerCellphoneIndicator: 1
    },
  });
        ...
        <StyledPaymentsMethodsContainer>
          ...
          <StyledPaymentsMethodsInnerContainer>
            ...
            applicationForm.status.id === 7 ? (
              ...
              <TextFieldControlled
                inputValue={applicationForm.receiptNumber || 'REC123456789'}
                id={'receiptNumber'}
                placeholder={''}
                label={'Receipt No.'}
                name={'receiptNumber'}
                ...
                fullWidth={true}
                control={controlProofOfPayment}
                error={!!errorsProofOfPayment.receiptNumber}
