...
export const StyledApplicationReviewStep4Container = styled.div.attrs({
  className: 'StyledApplicationReviewStep4Container',
})`
  && {
    ${tw`relative`}
  }
`;
export const StyledBoardMemeberAdjudcationContainer = styled.div.attrs({
  className: 'StyledBoardMemeberAdjudcationContainer',
})`
  && {
    ${tw`relative`}
    margin-top: 48px;
...
export const StyledDescriptionBoardMemberApproval = styled(Typography).attrs({
  className: 'StyledDescriptionBoardMemberApproval StyledTypographyBook',
})`
  && {
    display: flex;
    align-items: center;
